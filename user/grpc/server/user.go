...
import (
	...
	"github.com/galamshar/microservices-wallet/user/internal/cache"
	internal "github.com/galamshar/microservices-wallet/user/internal/storage"
	"github.com/galamshar/microservices-wallet/user/models"
	"github.com/galamshar/microservices-wallet/user/storage"
)
...
func (s *Server) MakeTransaction(ctx context.Context, request *TransactionRequest) (*NewTransactionResponse, error) {
	...
	fromUserDB.Balance = fromUser.Balance - request.Amount

	var toUserDB *models.User = new(models.User)
	toUserDB.Balance = toUser.Balance + request.Amount
